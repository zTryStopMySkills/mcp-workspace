  ...
  return (
    ...
    >
      <button
        ...
        className="w-full p-4 bg-white/[0.03] hover:bg-white/[0.07] border border-white/8 hover:border-white/15 rounded-2xl transition-all text-left flex flex-col items-center gap-2"
      >
        <FolderSvg />
        {renaming ? (
          <div
